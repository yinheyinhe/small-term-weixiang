...
# 全局变量
camera_host_ip = '127.0.0.1'
camera_host_port = 5001
save_video_path = '/home/mzssg1/old_people_system/supervision/records/'+location+'_datetime.avi'.replace('datetime', time.strftime('%Y%m%d-%H%M%S',time.localtime(time.time())))
