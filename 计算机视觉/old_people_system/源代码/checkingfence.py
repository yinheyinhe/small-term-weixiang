...
# 全局变量
prototxt_file_path='/home/mzssg1/old_people_system/models/mobilenet_ssd/MobileNetSSD_deploy.prototxt'
...
model_file_path='/home/mzssg1/old_people_system/models/mobilenet_ssd/MobileNetSSD_deploy.caffemodel' 
output_fence_path = '/home/mzssg1/old_people_system/supervision/fence'
		...
		# to determine direction
			...
			if not to.counted:
				...
				# center line, count the object
					...
					cv2.imwrite(os.path.join(output_fence_path, 'snapshot_%s.jpg' %(time.strftime('%Y%m%d_%H%M%S'))), frame)# snapshot
